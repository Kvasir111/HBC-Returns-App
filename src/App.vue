      ...
      <div class="p-2" id="customerInformation">
        <div class="text-center">
          <input
            ...
            required
            type="text"
            v-bind:aria-valuemax="customerName"
...
<select id="returnType" class="form-select m-2 bg-gray-200 text-black" v-model="returnType">
	<option disabled selected>Select Reason</option>
  <option v-for="(returnOption,index) in returnOptions" v-bind:value="returnOption.value" :key="index">
    {{ returnOption.text }}
  </option>
</select>
        ...
        <!-- <select
          id="returnType"
          class="form-multiselect m-2 bg-gray-200 text-black"
          v-model="returnType"
        >
          <option value="" disabled selected>Select a reason for return</option>
      ...
      <div class="mx-auto block" id="notes">
        <div v-if="returnType === 'Cancelling Service'">
          <textarea
            class="mx-auto block bg-gray-200 p-2 max-w-2xl"
            cols="50"
        ...
        <div v-if="returnType === 'Exchange/Defective Equipment'">
          <textarea
            class="mx-auto block bg-gray-200 p-2 max-w-2xl"
            cols="50"
            placeholder="Enter CMAC/SN of new Equipment"
            rows="4"
            v-model="notes"
          ></textarea>
        </div>

    ...
    export default {
        ...
        methods: {
            ...
            exportPDF() {
                ...
                doc.addImage(img, "JPEG", 2.25, 0, 4, 2);
                doc.text(compiledString, 1, 3);
            ...
            writeCustomerString(doc) {
                ...
                for (let i = 0 ; i < customerInformation.length ; i++){
                    ...
                    doc.text(customerInformation[i].text);
                    doc.setFontType('normal');
                    doc.text(customerInformation[i].value);
                    doc.text()
                }
                return doc;
            },
            writeEquipmentString() {
                let str = "";

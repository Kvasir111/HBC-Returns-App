			...
			<form autocomplete="off" class="card"
				...
				<div class="text-center mx-auto" id="equipmentInformation">
					...
					<transition-group enter-active-class="animated zoomIn"
					                  ...
					                  name="slideIn"
					                  tag="div">
						<div :key=row.id v-for="(row, index) in rows">
							<select
									class="mb-2 border-b-2 border-blue-500 p-2 bg-transparent focus:outline-none" id="equipmentType" required
									v-model="rows[index].device">
							...
							<input autocapitalize="characters" autocomplete="off"
							       class="mb-2 border-b-2 border-blue-500 p-2 bg-transparent inline-flex m-2 focus:outline-none focus:border-blue-800"
							       id="CMAC/SN input"
							       maxlength="12"
							       minlength="12"
							       placeholder="CMAC"
							...
							<div class="md:inline align-baseline">
								...
								<button type="button" v-on:click="removeElement(index)">
									<x_button class="inline" color="#E81123" size="28"/>
								</button>
							</div>
						</div>
					</transition-group>
				...
				<div id="returnInformation">
					...
					<div>
						<div class="text-center" id="return-information">
							<select class="mb-2 border-b-2 border-blue-500 p-2 bg-transparent focus:outline-none"
						...
						<textarea
								class="w-full text-center md:text-left md:w-2/3 p-2 border-2 border-blue-500 rounded bg-transparent focus:outline-none"
								id="explanation"
								rows="4"
